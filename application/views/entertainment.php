...
<body>
		...
		<div class='wrap'>
			<div class="m-nav-left">
				<ul>
					...
					<li class="selected"><a href="browse/entertainment" >娱乐</a></li>
				...
				<li class='hot-con-li'>
					<div class="list-item">
						...
						<div class='z-lump'>
							...
							<p class='z-raising'>"已筹资"<em>￥</em><i><?php echo $project->raised_money;?></i></p>
	...
	<div class='commn wrap'>
		<div class='wrap m-headline'>
				...
				<!-- <div><a class='z-browse' href="javascrpt:;">浏览全部</a></div> -->
		</div>
		...
		<div class="wrap focus-box">
			<ul class="focus-con">
				...
				<li class='focus-con-li'>
					<div class="list-item">
						<a href="" class="item-figure fill-out">
							<img src="assets/front/img/<?php echo $tech_project->pro_cover;?>" alt="">
						</a>
						<div class='z-lump'>
							<h2><a href='javascript:;'><?php echo $tech_project->name;?></a></h2>
							<p class='z-raising'>"已筹资"<em>￥</em><i><?php echo $tech_project->raised_money;?></i></p>
							<div class='progress' ><div style="width:<?php echo ceil(($project->raised_money/$project->raise_money)*100);?>%;"></div></div>
