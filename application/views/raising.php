	...
	<div class='m-subnav'>
		<div class='wrap'>
			...
			<div class="m-nav-right">
				<ul>
					<li><a href="product.html">众筹制造</a></li>
					<li><a href="local.html" >地方站</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class='wrap m-box'>
		<div class="wrap deputy-nav">
				<ul class='m-deputy all'>
					<li class="m-deputy-left-li" href="javascript:;"><a class='browse'href='javascript:;'>众筹中(<?php echo $sum->raising_sum;?>)</a></li>
					<li>
						<ul class='ul-slide ul-slide-left'>
							<li><a href="browse/index">所有项目</a></li>
			...
			<ul class="focus-con">
				...
				<li class='focus-con-li'>
					<div class="list-item">
						...
						<div class='z-lump'>
							<h2><a href='javascript:;'><?php echo $project->intro->intro;?></a></h2>
						...
						<div class='z-assist'>
							<div class='z-assist-clearfix'><a class='assist1' href=""><?php echo $project->like_sum->like_sum;?></a><a class='assist2' href=""><?php echo $project->comment_sum->comment_sum;?></a></div>
						</div>	
					</div>
				</li>
				<?php }?>
