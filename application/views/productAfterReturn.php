...
<body>
	...
	<div class="content">
		...
		<table id="return">
			...
			<?php 
				$i=0;
				if($support_type){
				foreach($support_type as $sutype){
				$i=$i+1;?>
				<tr>
					<td style="width: 40px"><?php echo $i;?></td>
					<td style="width: 80px"><?php echo $sutype->support_money;?></td>
					<td style="width: 290px"><?php echo $sutype->support_report;?></td>
					<td style="width: 60px">
						<a class="delete-return" support-id="<?php echo $sutype->support_type_id;?>" href="javascript:;">删除</a><br>
						<a class="update-return" support-id="<?php echo $sutype->support_type_id;?>" href="javascript:;">编辑</a>
					</td>
		...
		<form class="product-information" action="" method="">
			...
			<div class="all-infor return-number">
				...
				<input class="return-num" value="<?php echo $i;?>" />
			</div>
			<div class="all-infor">
				<span class="save">
					<a class="save-is" href="javascript:;">保存</a>
					<a class="alter-is" href="javascript:;">修改</a>
				</span>
				<span class="step">
	...
	<div id="alert-box-ok">
		...
		<span class="alert-content"> &nbsp &nbsp 保存成功！</span>
		<span class="alert-sure">
			<a href="javascript:;">确定</a>
		</span>
	</div>
	<div id="alert-box-delete">
		<span class="alert-title">&nbsp &nbsp提示
			<a class="no-delete" href="javascript:;">X</a>
		</span>
		<span class="alert-content"> &nbsp &nbsp 确认删除吗？</span>
		<span class="alert-sure">
			<a class="no-delete" href="javascript:;">取消</a>
			<a class="is-delete" href="javascript:;">确定</a>
		</span>
	</div>
	<div id="alert-box-typenum">
		<span class="alert-title">&nbsp &nbsp提示
			<a class="no-do" href="javascript:;">X</a>
		</span>
		<span class="alert-content"> &nbsp &nbsp 回报类型的数量至少三个！</span>
		<span class="alert-no-do">
			<a class="no-do" href="javascript:;">确定</a>
		</span>
	</div>
