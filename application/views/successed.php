	...
	<div class='wrap m-box'>
		<div class="wrap deputy-nav">
				<ul class='m-deputy all'>
					<li class="m-deputy-left-li" href="javascript:;"><a class='browse'href='javascript:;'>已成功(<?php echo $sum->successed_sum;?>)</a></li>
					<li>
			...
			<ul class="focus-con">
				...
				<li class='focus-con-li'>
					<div class="list-item">
						...
						<div class='z-assist'>
							<div class='z-assist-clearfix'><a class='assist1' href="javascript:;"><?php echo $project->like_sum->like_sum;?></a><a class='assist2' href="javascript:;"><?php echo $project->comment_sum->comment_sum;?></a></div>
						</div>	
					</div>
				</li>
				<?php }?>
