				...
				<div class="project-box">
					<div class="project-con fl w760">					
						<div class="project-msg">	
							...
							<div class="form-item clearfix">
								<label>真实姓名：</label>
								<input type="text" class="w198 wx-inputErrBorder publisher-name" >
							...
							<div class="form-item clearfix">
								...
								<div class="option-box">
	        						...
	        						<select class="province"  name="province" onChange = "select()" value="">
										<option selected="selected" value="<?php echo $project->province;?>"><?php echo $project->province;?></option>
									</select>
									<select class="city"  name="city" onChange = "select()"  value="">
										<option  value="<?php echo $project->city;?>"><?php echo $project->city;?></option>
							...
							<div class="form-item clearfix">
								<label>移动电话：</label>
								<input type="text" class="w198 publisher-tel" value="" name="ex_contact" wx-validator-rule="required|mobile">
							...
							<div class="form-item clearfix">
								<label>银行名称：</label>
								<input class="inp-418 bank-name" type="text" value="" name="bank_name" wx-validator-rule="required">
								<span class="error-text bank-name-error-text" style="">不能为空</span>
							</div>
							<div class="form-item clearfix">
								<label>开户支行：</label>
								<input class="inp-418 part-bank" type="text" value="" name="bank" wx-validator-rule="required">
								<span class="error-text part-bank-error-text" style="">不能为空</span>
							</div>
							<div class="form-item clearfix">
								<label>开户名称：</label>
								<input class="inp-418 open-name" type="text" value="" name="bank_user_name" wx-validator-rule="required">
								<span class="error-text open-name-error-text" style="">不能为空</span>
							</div>
							<div class="form-item clearfix">
								<label>银行账号：</label>
								<input class="inp-418 bank-count" type="text" value="" name="bank_card" wx-validator-rule="required">
							...
							<div class="action tc">
								...
								<a id="Js-save" href="javascript:void(0);" class="btn-effect-blue btn-sub w170 save-publisher">保存草稿</a>
