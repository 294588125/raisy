...
<head>
	...
	<link rel="stylesheet" href="assets/front/css/send_comment.css">
...
<?php include"person_header.php"?>
		...
		<div class="setting">			
			...
			<div class="sidebar">
				<ul class='setting-list'>
					...
					<li class="selected"><a href="comment/send_comment">发出的评论</a></li>
						...
						<li>
							<div class="name">
								...
								<div class="content-comment">
									<p>&nbsp;评论&nbsp;<a href="#"><?php echo $comment->name;?></a>&nbsp;|&nbsp;<span><?php echo $comment->add_time;?></span></p>		
									<p class="comment-detail"><?php echo $comment->content;?></p>					
								</div>
							</div>
							<p class='operate'>								
								<a class="delete" comment-id='<?php echo $comment->comment_id;?>' href="javascript:;">删除</a>
							</p>
						</li>
						<?php }?>
					</ul>
	...
	<div class="delete-send">
		...
		<div class="btn">
			...
			<a href="javascript:;" comment-id='' class="send-ensure" type="submit">确定</a>		
		</div>
	</div>
