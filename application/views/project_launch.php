			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $project->raise_money;?>元<br><br><?php echo ceil(($project -> raised_money / $project -> raise_money) * 100) ?>%</td>
						<td>
							
							<?php 
								if($project->is_publish==1&&$project->is_pass==0||($project->is_publish==0&&$project->is_pass==0)){
							?>
								&nbsp;&nbsp;草稿
								<br><br>
								<a href="product/pubStepTwo_prev/<?php echo $project->project_id;?>">编辑</a><a href="#">预览</a>
							<?php	
								}else if($project->is_publish==1&&$project->is_pass==1){
							?>
								<a href="javascript:;"></a><a href="#">预览</a>
							<?php } ?>
